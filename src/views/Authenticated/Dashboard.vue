<template>
  <div class="min-h-screen bg-gray-50 p-6">
    ...
    <div class="flex items-center justify-between mb-8">
      <h1 class="text-3xl font-bold text-gray-800">Forest Products Dashboard</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      <div class="bg-white rounded-xl shadow-sm p-6 transform hover:scale-105 transition-transform duration-200">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-sm font-medium text-gray-500">Total Collectors</p>
            <p class="text-2xl font-bold text-gray-900 mt-1">{{ totalCollectors }}</p>
          </div>
      ...
      <div class="bg-white rounded-xl shadow-sm p-6 transform hover:scale-105 transition-transform duration-200">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-2xl font-bold text-gray-900 mt-1">{{ mostCollectedProduct }}</p>
          </div>
      ...
      <div class="bg-white rounded-xl shadow-sm p-6 transform hover:scale-105 transition-transform duration-200">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-2xl font-bold text-gray-900 mt-1">{{ totalRoutes }}</p>
          </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
      <div class="bg-white rounded-xl shadow-sm p-6">
        <h3 class="text-lg font-semibold text-gray-800 mb-6">Most Collected Forest Products</h3>
        <canvas id="mostCollectedChart" class="w-full h-64"></canvas>
      </div>

      <div class="bg-white rounded-xl shadow-sm p-6">
        <h3 class="text-lg font-semibold text-gray-800 mb-6">Products Distribution</h3>
        <div class="space-y-4">
          <ul class="divide-y divide-gray-200">
        <li v-for="item in paginatedData" 
            :key="item.id" 
            class="py-3 flex items-center justify-between cursor-pointer hover:bg-green-100 transition-colors rounded-lg px-4"
