          ...
          <div class="flex">
            ...
            <div class="ml-3">
              <p class="text-sm text-blue-700">
                <span class="font-medium">Important:</span> Collection records can only be edited or deleted if they are unpaid. Once a record is marked as paid, it becomes permanent and cannot be modified.
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="flex">
            ...
            <div class="ml-3">
              <p class="text-sm text-green-700">
                <span class="font-medium">Payment Process:</span> When a record is marked as paid, the system automatically generates a forest conservation permit and deducts the collected quantities from the available stock. The permit can then be downloaded.
              </p>
            </div>
          </div>
        </div>
