<template>
    ...
    >
      <div
        class="relative flex flex-col bg-white dark:bg-gray-900 rounded-lg shadow-xl max-w-5xl w-[95%] sm:w-[90%] max-h-[95vh] overflow-hidden transition-transform duration-300 scale-100"
      >
        <!-- Header -->
        <div
        ...
        <!-- Image Container -->
        <div
          class="relative flex-grow overflow-hidden bg-gray-100 dark:bg-gray-800/80 flex items-center justify-center p-4"
        ...
        >
          ...
          <button
            ...
            class="absolute left-4 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-black/40 text-white hover:bg-black/60 focus:outline-none focus:ring-2 focus:ring-white/50 disabled:opacity-30 disabled:cursor-not-allowed transition-all"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-6 w-6"
          ...
          <button
            ...
            class="absolute right-4 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-black/40 text-white hover:bg-black/60 focus:outline-none focus:ring-2 focus:ring-white/50 disabled:opacity-30 disabled:cursor-not-allowed transition-all"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-6 w-6"
        ...
        <div v-if="imageCount > 1" class="flex items-center justify-center p-2 bg-gray-50 dark:bg-gray-900/80 border-t border-gray-200 dark:border-gray-700/50">
          <div class="flex space-x-2 overflow-x-auto py-2 px-4 max-w-full">
            <button
              v-for="(image, index) in allImages"
              :key="index"
              @click="selectImage(image, index)"
              class="w-16 h-16 rounded-md overflow-hidden flex-shrink-0 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
