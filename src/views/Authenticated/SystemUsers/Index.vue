...
const fetchUsers = async () => {
  ...
  if (error) {
    ...
    // Ensure last_name is an empty string if null or undefined
    data.forEach(user => {
      if (!user.last_name) {
        user.last_name = ''
      }
        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            ...
            >
              ...
              <!-- Replace the existing Role column in the main table with this -->
                ...
                <div v-if="isFPUAdmin && user.id !== getUser().id">
                  ...
                  >
                    ...
                    <option value="3">VSU Cash Division</option>
              ...
              'bg-gray-100 text-gray-800': user.role.name === 'VSU Cash Division',
