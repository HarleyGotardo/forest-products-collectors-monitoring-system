          ...
          <tbody class="bg-white divide-y divide-gray-200">
            ...
            >
              ...
              >
                <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    ...
                    <div class="ml-4">
                      ...
                      <div
                        class="block sm:hidden text-sm text-gray-600 rounded-2xl mt-1 bg-green-100 px-2 py-1 w-max"
                      >
                        {{ user.role.name }}
                      </div>
                    </div>
                ...
                <td
                  class="px-4 hidden sm:table-cell sm:px-6 py-4 whitespace-nowrap"
                >
              ...
              <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                  <tr>
                    ...
                    <th
                      class="hidden sm:table-cell px-4 sm:px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider"
                    >
                      Actions
                    </th>
                  </tr>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  ...
                  >
                    <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                      <div class="flex items-center">
                        ...
                        <div class="ml-4 text-left">
                          ...
                          <div
                            class="block sm:hidden text-left text-sm font-medium mt-2"
                          >
                    ...
                    <td
                      class="hidden sm:table-cell px-4 sm:px-6 py-4 whitespace-nowrap text-right text-sm font-medium"
                    >
                      <button
                        @click="approveUser(user.id)"
                        class="px-3 sm:px-4 py-2 bg-gray-900 text-white rounded-lg shadow-sm hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
  ...
  >
    <AlertDialogContent>
      ...
      <AlertDialogFooter>
        ...
        >
        <AlertDialogAction @click="handleApproveConfirm"
    ...
    <AlertDialogContent>
      ...
      <AlertDialogFooter>
        <AlertDialogCancel @click="showRejectDialog = false"
          >Cancel</AlertDialogCancel
        >
        <AlertDialogAction @click="handleRejectConfirm"
