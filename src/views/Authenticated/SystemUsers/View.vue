...
<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 bg-gray-50">
    ...
    >
      ...
      <div class="px-6 sm:px-8 py-6 bg-[#047857] flex items-center">
        <!-- Avatar with Ring -->
        <div
        ...
        <h2 class="text-2xl font-bold text-white ml-4">
      ...
      <div class="p-4 sm:p-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div
            class="space-y-1 transition-all duration-300 p-3 rounded-lg hover:bg-gray-50"
          >
            <label
            ...
            <p class="text-base text-gray-900 font-medium break-all">
              {{ user.email_address }}
            </p>
          </div>
          ...
          >
            ...
            <div class="flex items-center pt-1">
              <span
                class="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-gradient-to-r from-[#10b880] to-[#4b977e] text-white border border-[#10b880]"
              >
                {{ user.role.name }}
              </span>
            </div>
          ...
          >
            ...
            <p class="text-base text-gray-900 font-medium">
              {{ user.birthdate ? new Date(user.birthdate).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: '2-digit' }) : 'Not Provided' }}
              <br />
              {{ user.birthdate ? Math.floor((new Date() - new Date(user.birthdate)) / (365.25 * 24 * 60 * 60 * 1000)) : 'Not Provided' }}
              Years Old
            </p>
          </div>
          ...
          >
            ...
            <p class="text-base text-gray-900 font-medium">{{ user.sex }}</p>
          </div>
        </div>
      </div>
    </div>
