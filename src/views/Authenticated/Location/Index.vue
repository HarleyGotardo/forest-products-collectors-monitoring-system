          ...
          <div class="flex">
            ...
            <div class="ml-3">
              <p class="text-sm text-blue-700">
                <span class="font-medium">Deletion:</span> You can't delete a
                location if the location have records and request
                references.
              </p>
            </div>
          </div>
        ...
        <tr v-if="filteredLocations.length === 0">
          <td colspan="4" class="px-6 py-12 text-center">
            <div class="flex flex-col items-center">
              <img src="@/assets/location2.png" alt="" class="w-12 h-12 mb-4" />
